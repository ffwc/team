...
import com.example.android.new_nds_study.adapter.WebSiteSlideRecyclerViewHolder;


public class WebSiteSlideRecyclerView extends RecyclerView {
    ...
    public WebSiteSlideRecyclerView(Context context) {
        this(context, null);
    }

    public WebSiteSlideRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WebSiteSlideRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    /**
     * 使用的Activity或Fragment失去焦点时，如果侧边栏打开状态，关闭侧边栏
     * 当前还有小bug，先不上
     */
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    WebSiteSlideRecyclerViewHolder viewHolder = (WebSiteSlideRecyclerViewHolder) getChildViewHolder(view);


                    mItemLayout = viewHolder.itemlayout;
                    mPosition = viewHolder.getAdapterPosition();

                    mDelete = (TextView) mItemLayout.findViewById(R.id.item_delete_layout);
