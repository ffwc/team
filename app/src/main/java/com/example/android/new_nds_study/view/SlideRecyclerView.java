        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    if (getChildViewHolder(view) instanceof PaintHistoryAdapter.FooterViewHolder){
                        return false;
                    }
                    PaintHistoryAdapter.Holder viewHolder = (PaintHistoryAdapter.Holder) getChildViewHolder(view);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mItemLayout==null && mListener!=null){
                    mListener.onItemClick(mItemLayout, mPosition);
